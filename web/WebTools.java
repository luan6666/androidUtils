package com.smz.yongji.web.tencentx5.utils;
...
import com.smz.yongji.BuildConfig;
...
public class WebTools {
    ...
    public static void copy(String content) {
        if (!TextUtils.isEmpty(content)) {
            if (android.os.Build.VERSION.SDK_INT < android.os.Build.VERSION_CODES.HONEYCOMB) {
                ClipboardManager clipboard = (ClipboardManager) MyApp.newInstance().getSystemService(Context.CLIPBOARD_SERVICE);
    ...
    public static void showToast(String content) {
        if (!TextUtils.isEmpty(content)) {
            Toast.makeText(MyApp.newInstance().getApplicationContext(), content, Toast.LENGTH_SHORT).show();
        }
    }
}
